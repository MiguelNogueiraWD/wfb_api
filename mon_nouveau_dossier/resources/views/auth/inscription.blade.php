                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route("register.post")}}">
                                @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="password" placeholder="Mot de passe" id="password" class="form-control" name="mdp" required>
                                        @if ($errors->has('mdp'))
                                            <span class="text-danger">{{ $errors->first('mdp') }}</span>
                                        @endif     
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="password" placeholder="Confirmez le mot de passe" id="password_confirmation" class="form-control" name="mdp_confirmation" required>
